  ...
  return (
    ...
    >
      ...
      <section id="scope" className="mb-10 scroll-mt-24">
        ...
        <ul>
          <li>The Sunny WhatsUp web application and all subdomains</li>
      ...
      <section id="definitions" className="mb-10 scroll-mt-24">
        ...
        <DefinitionTable
          rows={[
            ...
            ['Company / Tenant', 'A business entity registered on the Platform as a Company Admin'],
            [
              'Company Admin',
      ...
      <section id="information-collected" className="mb-10 scroll-mt-24">
        ...
        <ul>
          <li>Template names, languages, categories (Marketing, Utility, Authentication)</li>
          <li>
        ...
        <p>When you authorise our platform via the Meta Embedded Signup flow, Meta returns:</p>
        <ul>
          <li>
      ...
      <section id="how-used" className="mb-10 scroll-mt-24">
        ...
        <ul>
          ...
          <li>Sending WhatsApp messages via the Meta Graph API using your WABA credentials</li>
        ...
        <ul>
          <li>Verifying identity and authentication at every API request via JWT validation</li>
          <li>
            Rate limiting (300 requests per 15-minute window per IP by default) to prevent
            abuse
          </li>
          <li>Audit logging of all sensitive administrative actions for security investigation</li>
      ...
      <section id="legal-bases" className="mb-10 scroll-mt-24">
        ...
        <DataTable
          ...
          rows={[
            ...
            ['Legal holds and compliance records', 'Legal obligation (Art. 6(1)(c))'],
            [
      ...
      <section id="meta-integration" className="mb-10 scroll-mt-24">
        ...
        <ol>
          ...
          <li>Upon your authorisation, Meta returns an OAuth code to our backend</li>
          <li>
        ...
        <ul>
          ...
          <li>Message delivery status callbacks (if webhook integration is configured)</li>
        </ul>
        ...
        <p>
          ...
          temporary 24-hour access tokens, or System User tokens. These are treated identically
          to production credentials in terms of encryption and storage practices.
        </p>
      </section>
      ...
      <section id="security" className="mb-10 scroll-mt-24">
        ...
        <ul>
          <li>All API endpoints require a valid JWT bearer token (1-day expiry)</li>
          <li>
            Role-based access control (RBAC) enforced server-side: <code>company_admin</code>{' '}
            and <code>super_admin</code> roles with distinct permission sets
          </li>
          <li>
        ...
        <p>
          HTTP security headers are applied via Helmet.js: <code>X-Content-Type-Options</code>,{' '}
          <code>X-Frame-Options</code>, <code>Strict-Transport-Security</code>,{' '}
          <code>Content-Security-Policy</code>, and others. The <code>X-Powered-By</code> header
          is removed to reduce fingerprinting surface.
        </p>

        <SubHeading>11.5 Audit Logging</SubHeading>
        <p>
          All sensitive actions (login, company approval/rejection, WABA connect/disconnect,
          template create/delete) are recorded in <code>audit_logs</code> with actor identity,
          action type, target entity, and timestamp. Audit records are append-only and cannot
          be deleted by Company Admins.
        </p>
      ...
      <section id="archival" className="mb-10 scroll-mt-24">
        ...
        <p>
          ...
          <strong>archive snapshot</strong> in a separate <code>data_archive_events</code>{' '}
          table before deletion. This archive is accessible only to Sunny WhatsUp&apos;s
          authorised technical staff (Super Admins) and is used solely for:
        </p>
        <ul>
        ...
        <ul>
          <li>
            ...
            <strong>the encrypted access token is REDACTED and not included in the archive</strong>
          </li>
          <li>Phone number records (phone number IDs, display numbers, verified names)</li>
        ...
        <ul>
          <li>
            Archive records are retained for <strong>3 years</strong> from creation
          </li>
        ...
        <p>
          ...
          request, we will delete your archived data from <code>data_archive_events</code>{' '}
          subject to any overriding legal retention obligations. Send requests to{' '}
          <a href={`mailto:${LEGAL.CONTACT_EMAIL}`}>{LEGAL.CONTACT_EMAIL}</a> with subject
      ...
      <section id="cookies" className="mb-10 scroll-mt-24">
        ...
        <ul>
          ...
          <li>Third-party analytics cookies (e.g., Google Analytics, Facebook Pixel)</li>
        ...
        <ul>
          ...
          <li>
            <code>sunny_whatsup_auth_user</code>: A JSON object containing your non-sensitive
            user profile data (name, email, role, company name/status)
          </li>
        </ul>
      ...
      <section id="rights" className="mb-10 scroll-mt-24">
        ...
        <p>
          ...
          <a href={`mailto:${LEGAL.CONTACT_EMAIL}`}>{LEGAL.CONTACT_EMAIL}</a> with your name,
          email address, and a description of your request. We will verify your identity
        ...
        <DataTable
          ...
          rows={[
            ...
            ['Lodge a Complaint', 'Lodge a complaint with your national data protection authority'],
          ]}
        />
      ...
      <section id="children" className="mb-10 scroll-mt-24">
        ...
        <p>
          ...
          <a href={`mailto:${LEGAL.CONTACT_EMAIL}`}>{LEGAL.CONTACT_EMAIL}</a> and we will take
          steps to delete such information as quickly as possible.
        </p>
      </section>
      ...
      <section id="changes" className="mb-10 scroll-mt-24">
        ...
        <ul>
          ...
          <li>Sending an email to the registered email address of Company Admins</li>
      ...
      <section id="addenda" className="mb-10 scroll-mt-24">
        ...
        <p>
          ...
          <a href={`mailto:${LEGAL.CONTACT_EMAIL}`}>{LEGAL.CONTACT_EMAIL}</a> to request a DPA.
        </p>
        ...
        <p>
          ...
          <a href={`mailto:${LEGAL.CONTACT_EMAIL}`}>{LEGAL.CONTACT_EMAIL}</a> for requests.
        </p>
